...
import type { GaugeReport, ToolId, UsageEvent, WindowKey } from '@core/types'
...
export const SCENARIOS: readonly DemoScenario[] = [
  { id: 'underfarming', key: '1', label: 'Underfarming', zone: 'underuse', pace: 0.3, habitualPace: 0.42, currentPct: 11, resetFraction: 0.62, activeHours: 11 },
  { id: 'coasting', key: '2', label: 'Coasting', zone: 'profitable', pace: 0.68, habitualPace: 0.74, currentPct: 34, resetFraction: 0.55, activeHours: 24 },
  { id: 'maxxing', key: '3', label: 'Maxxing', zone: 'clear', pace: 1.0, habitualPace: 0.96, currentPct: 52, resetFraction: 0.48, activeHours: 38 },
  { id: 'redlining', key: '4', label: 'Redlining', zone: 'warn', pace: 1.3, habitualPace: 1.05, currentPct: 63, resetFraction: 0.4, activeHours: 49 },
  { id: 'way-too-fast', key: '5', label: 'Way Too Fast', zone: 'noreturn', pace: 1.72, habitualPace: 1.18, currentPct: 78, resetFraction: 0.3, activeHours: 62 },
  { id: 'capped', key: '6', label: 'Capped', zone: 'over', pace: 2.2, habitualPace: 1.35, currentPct: 100, resetFraction: 0.18, activeHours: 76 },
]

const SCENARIO_BY_ID = Object.fromEntries(SCENARIOS.map((s) => [s.id, s]))

const STORAGE_KEY = 'cc-gauge:demo'
